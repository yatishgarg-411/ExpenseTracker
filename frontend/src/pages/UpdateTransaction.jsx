        ...
        <div className="container">
            <div className="card">
                <div className="header">
                    ...
                    <h1 className="header-title-addTransaction">Update Old Transaction</h1>
                </div>
                ...
                <div className="form-wrapper">
                    <form className="form" onSubmit={(e) => {
                        ...
                        <div className="button-group">
                            <button type="submit" className="submit-btn" onClick={updateTransaction}>Update Transaction </button>
